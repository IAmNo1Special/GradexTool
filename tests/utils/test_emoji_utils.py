...
def setup_mock_response(session_mock: Any, method: Any, status: Any, json_data: Any=None, text_data: Any="", content: Any=b"") -> Any:
...
@pytest.mark.asyncio
async def test_img_url_to_emoji_size_success(mock_session: Any, dummy_image_bytes: Any) -> None:
...
async def test_create_application_emoji_success(mock_session: Any) -> None:
    setup_mock_response(mock_session, 'post', 201, json_data={"name": "test_emoji", "id": "12345"})
...
async def test_list_application_emojis_success(mock_session: Any) -> None:
    setup_mock_response(mock_session, 'get', 200, json_data={"items": [{"name": "emoji1", "id": "1"}, {"name": "emoji2", "id": "2"}]})
...
async def test_get_application_emoji_success(mock_session: Any, capsys: Any) -> None:
    setup_mock_response(mock_session, 'get', 200, json_data={"name": "emoji1", "id": "1"})
...
async def test_modify_application_emoji_success(mock_session: Any, capsys: Any) -> None:
    setup_mock_response(mock_session, 'patch', 200, json_data={"name": "new_name", "id": "1"})
...
async def test_create_emoji_from_url(mock_create_app_emoji: Any, mock_img_url_to_emoji: Any) -> None:
...
async def test_create_revomon_emojis_success(mock_get_attrs: Any, mock_revo_table: Any, mock_create_emoji: Any, mock_list_emojis: Any) -> None:
...
async def test_create_land_emojis(mock_lands_table: Any, mock_create_emoji: Any, mock_list_emojis: Any) -> None:
    ...
    mock_create_emoji.assert_called_once_with("http://test.com/land2.png", emoji_name="new_land")
