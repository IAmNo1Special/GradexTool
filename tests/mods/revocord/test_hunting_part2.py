...
class TestOnInteractionPart2:
    @pytest.mark.asyncio
    async def test_on_interaction_bad_data(
    ...
    async def test_expired_exception(
        self,
        mock_bcast: Any,
        mock_embed: Any,
        mock_del: Any,
    ...
    @patch("mods.revocord.portal.build_console_embed", new_callable=AsyncMock)
    @patch("mods.revocord.hunting.update_encounter_broadcast", new_callable=AsyncMock)
    async def test_spawn_run_exception(
        self,
        mock_bcast: Any,
        mock_embed: Any,
        mock_del: Any,
    ...
    async def test_spawn_fight(self, mock_bot: Any, mock_interaction: Any) -> None:
        ...
        mock_interaction.type = discord.InteractionType.component
        mock_interaction.data = {
            "custom_id": f"spawn_fight:123:1:0:{int(time.time())}:456"
        }
        mock_interaction.user.id = 123
        await cog.on_interaction(mock_interaction)
    ...
    async def test_spawn_share(
        self, mock_broadcast: Any, mock_bot: Any, mock_interaction: Any
    ) -> None:
        cog = HuntingCog(mock_bot)
        setattr(cog, "_cleanup_wilds_spawn", AsyncMock())
    ...
    @pytest.mark.asyncio
    async def test_spawn_share_no_message(
        self, mock_bot: Any, mock_interaction: Any
    ) -> None:
        cog = HuntingCog(mock_bot)
        setattr(cog, "_cleanup_wilds_spawn", AsyncMock())
    ...
    @pytest.mark.asyncio
    async def test_spawn_throw_orb_bad_data(
        self, mock_bot: Any, mock_interaction: Any
    ) -> None:
        cog = HuntingCog(mock_bot)
        setattr(cog, "_cleanup_wilds_spawn", AsyncMock())
    ...
    @pytest.mark.asyncio
    async def test_spawn_throw_orb_no_embeds(
        self, mock_bot: Any, mock_interaction: Any
    ) -> None:
        cog = HuntingCog(mock_bot)
        setattr(cog, "_cleanup_wilds_spawn", AsyncMock())
    ...
    @pytest.mark.asyncio
    @patch("mods.revocord.hunting.get_or_create_account", new_callable=AsyncMock)
    async def test_spawn_throw_orb_empty_orb(
        self, mock_get_acc: Any, mock_bot: Any, mock_interaction: Any
    ) -> None:
    ...
    @pytest.mark.asyncio
    @patch("mods.revocord.hunting.get_or_create_account", new_callable=AsyncMock)
    async def test_spawn_throw_orb_no_data(
        self, mock_get_acc: Any, mock_bot: Any, mock_interaction: Any
    ) -> None:
    ...
    async def test_spawn_throw_orb_success_all_branches(
        ...
        with (
            patch("mods.revocord.hunting.random.random", return_value=0.01),
            patch("pathlib.Path.exists", return_value=False),
        ):  # Force no image fallback
            await cog.on_interaction(mock_interaction)
    ...
    async def test_spawn_throw_orb_fail_flee_no_image(
        ...
        with (
            patch("mods.revocord.hunting.random.random", side_effect=[0.99, 0.1]),
            patch("pathlib.Path.exists", return_value=False),
        ):
            await cog.on_interaction(mock_interaction)
    ...
    async def test_cleanup_wilds_spawn_exception(
        self, mock_remove: Any, mock_bot: Any
    ) -> None:
        cog = HuntingCog(mock_bot)
    ...
    async def test_handle_wilds_claim_branches(
        self, mock_get_spawn: Any, mock_bot: Any, mock_interaction: Any
    ) -> None:
        cog = HuntingCog(mock_bot)
        setattr(cog, "_cleanup_wilds_spawn", AsyncMock())
        mock_interaction.type = discord.InteractionType.component
        ...
        with patch(
            "mods.revocord.hunting.save_active_encounter", new_callable=AsyncMock
        ):
            await cog.on_interaction(mock_interaction)
    ...
    @patch("mods.revocord.hunting.get_or_create_account", new_callable=AsyncMock)
    async def test_spawn_wild_no_revomons(
        self, mock_get_acc: Any, mock_biome: Any, mock_bot: Any, mock_interaction: Any
    ) -> None:
        cog = HuntingCog(mock_bot)
        setattr(cog, "_cleanup_wilds_spawn", AsyncMock())
        cog.revomons = []
    ...
    @patch("mods.revocord.hunting.get_guild_biome", new_callable=AsyncMock)
    @patch("mods.revocord.hunting.get_or_create_account", new_callable=AsyncMock)
    async def test_spawn_wild_no_guild(
        self, mock_get_acc: Any, mock_biome: Any, mock_bot: Any, mock_interaction: Any
    ) -> None:
        cog = HuntingCog(mock_bot)
        setattr(cog, "_cleanup_wilds_spawn", AsyncMock())
    ...
    @patch("mods.revocord.hunting.broadcast_encounter", new_callable=AsyncMock)
    async def test_spawn_wild_abilities(
        self,
        mock_bcast: Any,
        mock_save: Any,
        mock_get_acc: Any,
    ...
    async def test_initial_wilds_spawn(
        self, mock_get_config: Any, mock_bot: Any
    ) -> None:
    ...
    @pytest.mark.asyncio
    @patch("scripts.gradexDB.get_guild_spawn_config", new_callable=AsyncMock)
    async def test_initial_wilds_spawn_no_cog(
        self, mock_get_config: Any, mock_bot: Any
    ) -> None:
    ...
    @pytest.mark.asyncio
    @patch("scripts.gradexDB.get_guild_spawn_config", new_callable=AsyncMock)
    async def test_initial_wilds_spawn_exception(
        self, mock_get_config: Any, mock_bot: Any
    ) -> None:
        mock_get_config.return_value = {"max_spawn_limit": 3}
        mock_wild_cog = MagicMock()
