...
class TestSearchCommand:
    ...
    @pytest.mark.asyncio
    async def test_ability_search_embed(
        self, mock_revomon_table: Any, mock_abilities_table: Any, search_cog: Any
    ) -> None:
        mock_abilities_instance = mock_abilities_table.return_value
        mock_abilities_instance.get_info = AsyncMock(
            return_value=[("Blaze", "Powers up Fire-type moves.")]
        )
    ...
    @patch("mods.the_elders_library.search_command.AbilitiesTable")
    @pytest.mark.asyncio
    async def test_allabilities_embed(
        self, mock_abilities_table: Any, search_cog: Any
    ) -> None:
        mock_abilities_instance = mock_abilities_table.return_value
        mock_abilities_instance.get_names = AsyncMock(
            return_value=["Blaze", "Overgrow"]
        )
    ...
    @pytest.mark.asyncio
    async def test_fruity_search_embed(
        self, mock_fruitys_table: Any, search_cog: Any
    ) -> None:
        mock_fruitys_instance = mock_fruitys_table.return_value
        mock_fruitys_instance.get_info = AsyncMock(
            return_value=[("Apple", "Restores 20 HP", "healing")]
        )
    ...
    @patch("mods.the_elders_library.search_command.FruitysTable")
    @pytest.mark.asyncio
    async def test_allfruitys_embed(
        self, mock_fruitys_table: Any, search_cog: Any
    ) -> None:
        mock_fruitys_instance = mock_fruitys_table.return_value
    ...
    @pytest.mark.asyncio
    async def test_item_search_embed(
        self, mock_items_table: Any, search_cog: Any
    ) -> None:
        mock_items_instance = mock_items_table.return_value
        mock_items_instance.get_info = AsyncMock(
            return_value=[("Potion", "Heals 20 HP", "Shop", "100")]
        )
    ...
    @pytest.mark.asyncio
    async def test_move_search_embed(
        self, mock_revomon_moves_table: Any, mock_moves_table: Any, search_cog: Any
    ) -> None:
        mock_moves_instance = mock_moves_table.return_value
        # (0, Capsule, Name, Category, Type, Description, Accuracy, Damage, PP, Priority)
        mock_moves_instance.get_info = AsyncMock(
            return_value=[
                (
                    0,
                    1,
        ...
        mock_revomon_moves_instance.get_mons_for_move = AsyncMock(
            return_value=["Charmander"]
        )
    ...
    @pytest.mark.asyncio
    async def test_nature_search_embed(
        self, mock_natures_table: Any, search_cog: Any
    ) -> None:
        mock_natures_instance = mock_natures_table.return_value
        mock_natures_instance.get_info = AsyncMock(
            return_value=[("Adamant", "Attack", "Special Attack", "Spicy", "Dry")]
        )
    ...
    @patch("mods.the_elders_library.search_command.NaturesTable")
    @pytest.mark.asyncio
    async def test_nature_search_embed_neutral(
        self, mock_natures_table: Any, search_cog: Any
    ) -> None:
        mock_natures_instance = mock_natures_table.return_value
        mock_natures_instance.get_info = AsyncMock(
            return_value=[("Hardy", None, None, None, None)]
        )
    ...
    @patch("mods.the_elders_library.search_command.NaturesTable")
    @pytest.mark.asyncio
    async def test_allnatures_embed(
        self, mock_natures_table: Any, search_cog: Any
    ) -> None:
        mock_natures_instance = mock_natures_table.return_value
    ...
    @pytest.mark.asyncio
    async def test_abilities_command(
        self,
        mock_ability_search_embed: Any,
        ...
        interaction.response.send_message.assert_called_with(
            embed="all_embed", ephemeral=True
        )
