...
async def test_on_message(mock_respond: Any, cog: Any) -> None:
    ...
    with patch("mods.tiptops_shop.tiptop_shop.tiptop_shop.tiptop_shop_intro_embed", side_effect=Exception("Test Exception")):
...
@pytest.mark.asyncio
async def test_intro_buttons_tiptop_nft_items(mock_interaction: Any, mock_button: Any) -> None:
...
@pytest.mark.asyncio
async def test_intro_buttons_exit_embed(mock_interaction: Any, mock_button: Any) -> None:
    view = tiptop_shop.tiptop_shop_intro_buttons()
...
@pytest.mark.asyncio
async def test_nft_items_buttons_tiptop_gradex_tool(mock_interaction: Any, mock_button: Any) -> None:
...
@pytest.mark.asyncio
async def test_nft_items_buttons_tiptop_6000_igc(mock_interaction: Any, mock_button: Any) -> None:
    view = tiptop_shop.tiptop_shop_nft_items_buttons()
...
@pytest.mark.asyncio
async def test_nft_items_buttons_tiptop_60000_igc(mock_interaction: Any, mock_button: Any) -> None:
    view = tiptop_shop.tiptop_shop_nft_items_buttons()
...
@pytest.mark.asyncio
async def test_nft_items_buttons_tiptop_120000_igc(mock_interaction: Any, mock_button: Any) -> None:
    view = tiptop_shop.tiptop_shop_nft_items_buttons()
...
# --- 6000 IGC Buttons ---
@pytest.mark.asyncio
async def test_igc_6000_nft_buttons_redeem(mock_interaction: Any, mock_button: Any) -> None:
...
@pytest.mark.asyncio
async def test_igc_6000_nft_buttons_buy_revo(mock_interaction: Any, mock_button: Any) -> None:
    view = tiptop_shop.igc_6000_nft_buttons()
...
@pytest.mark.asyncio
async def test_igc_6000_nft_buttons_buy_igc(mock_interaction: Any, mock_button: Any) -> None:
    view = tiptop_shop.igc_6000_nft_buttons()
...
# --- 60000 IGC Buttons ---
@pytest.mark.asyncio
async def test_igc_60000_nft_buttons_redeem(mock_interaction: Any, mock_button: Any) -> None:
...
@pytest.mark.asyncio
async def test_igc_60000_nft_buttons_buy_revo(mock_interaction: Any, mock_button: Any) -> None:
    view = tiptop_shop.igc_60000_nft_buttons()
...
@pytest.mark.asyncio
async def test_igc_60000_nft_buttons_buy_igc(mock_interaction: Any, mock_button: Any) -> None:
    view = tiptop_shop.igc_60000_nft_buttons()
...
# --- 120000 IGC Buttons ---
@pytest.mark.asyncio
async def test_igc_120000_nft_buttons_redeem(mock_interaction: Any, mock_button: Any) -> None:
...
@pytest.mark.asyncio
async def test_igc_120000_nft_buttons_buy_revo(mock_interaction: Any, mock_button: Any) -> None:
    view = tiptop_shop.igc_120000_nft_buttons()
...
@pytest.mark.asyncio
async def test_igc_120000_nft_buttons_buy_igc(mock_interaction: Any, mock_button: Any) -> None:
    view = tiptop_shop.igc_120000_nft_buttons()
