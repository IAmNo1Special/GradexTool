...
async def test_get_movepool_success(
    mock_to_sentence_case: Any, mock_get_raw: Any
) -> None:
...
async def test_get_movepools_success(tmp_path: Any) -> None:
    ...
    with (
        patch("scripts.movepools.REVODEX_REVOMON_FILE", revomon_file),
        ...
        async def mock_get_pool(
            semaphore: Any, client: Any, revomon: Any, movepool_data: Any
        ) -> None:
...
def test_main() -> None:
    with (
        patch("scripts.movepools.get_movepools"),
