...
test = '''
    @pytest.mark.asyncio
    @patch("mods.core.enforcement.scripts.gradexDB.delete_guild_data", new_callable=AsyncMock)
    ...
    @pytest.mark.asyncio
    @patch("mods.core.enforcement.scripts.gradexDB.delete_guild_data", new_callable=AsyncMock, side_effect=Exception("DB Error"))
